...
from spellbind.actions import SimpleExtendAction, SimpleChangedAction
...
def test_iadd_notifies(constructor):
...
def test_iadd_item_list_changing_value_notifies():
    ...
    observers.assert_actions(SimpleExtendAction(3, (4, 5, 6)),
                             SimpleChangedAction(new_item=7, old_item=4))
