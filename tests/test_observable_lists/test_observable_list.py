...
def test_remove_notifies():
    ...
    observer.assert_called_once_with(2)
...
def test_reverse_notifies():
    ...
    observers.added_observers.assert_called_once(((0, 3), (1, 2), (2, 1)))
...
def test_iadd_notifies():
    ...
    observers.added_observers.assert_called_once(((3, 4), (4, 5)))
...
def test_imul_notifies(mul: int):
    ...
    observers.added_observers.assert_called_once(added_indices)
